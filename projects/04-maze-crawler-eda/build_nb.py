...
C00 = md(
    ...
    "covering 30 days of daily episode data and individual JSON replay files.\n"
    "\n"
    "**Analysis layers**\n"
    "\n"
...
C03 = code(
    ...
    "    ax.set_xlabel('Date')\n"
    "    ax.set_ylabel('Score')\n"
    "    ax.set_title('Score evolution -- top vs median agents over 30 days')\n"
    "    ax.legend()\n"
    "    ax.grid(True, axis='y')\n"
    "    plt.tight_layout()\n"
    "    plt.show()\n"
...
C34 = md(
    ...
    "\n"
    "**Macro trends** -- episode volume and storage grew steadily over 30 days;\n"
